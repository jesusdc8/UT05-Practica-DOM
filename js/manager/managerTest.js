...
import {ManagerException, ObjecManagerException, CategoryExistsException, ProductExistInCategoryException, CategoryNotExistException, ProductNotExistInManagerException, ProductNotExistInCategoryException} from './manager.js';
  ...
  let product1 = new Smartphone('100-100', 'Samsung', 'Galaxy s21', 1100, "Último Samsung", '5G', '256gb', 'black');
  let product2 = new Smartphone('100-101', 'Apple', 'Iphone 12 Pro', 1200, "El mejor Iphone", '5G', '128gb', 'white');
  let product3 = new Smartphone('100-102', 'Xiaomi', 'Mi 11', 500, "Xiaomi calidad precio", '5G', '256gb', 'black');
  let product4 = new Smartphone('100-103', 'Apple', 'Iphone 11', 900, "Iphone normal", '4G', '128gb', 'rose');

  let product5 = new Laptop('200-100', 'Acer', 'Aspire', 500, 'Lo mejor para ofimática', 'Intel i3 5400', '8gb', '500gb');
  let product6 = new Laptop('200-101', 'HP', 'Pavilion', 1000, 'Lo mejor para estudiantes', 'Intel i5 5400', '8gb', '500gb');
  let product7 = new Laptop('200-102', 'MSI', 'Ultra', 1300, 'Lo mejor para gamers', 'Intel i7 5400', '16gb', '1tb');
  let product8 = new Laptop('200-103', 'HP', 'UltraBook', 1000, 'Lo mejor para viajar', 'Intel i5 5400', '16gb', '500gb');

  let product9 = new Product('300-100', 'HP', 'OMEN', 1100, 'Sobremesa de HP');
  let product10 = new Product('300-101', 'SuperTienda', 'Ultra', 1200, 'Sobremesa montado por nosotros mismos');
  let product11 = new Product('300-102', 'SuperTienda', 'Mega', 1300, 'Sobremesa montado por nosotros mismos');
  let product12 = new Product('300-103', 'HP', 'Gaming', 1400, 'Sobremesa de HP para gaming');

  let product13 = new Tv('400-100', 'Lg', 'Oled', 1800, 'Negros más puros', '55', true);
  let product14 = new Tv('400-101', 'Samsung', 'Qled', 1200, 'Lo mejor de Samsung', '55', true);
  let product15 = new Tv('400-102', 'Lg', 'NanoCell', 1300, 'Última tecnologia', '60', true);
  let product16 = new Tv('400-103', 'Lg', '4k', 1400, 'Iniciación en alta resolución', '50', true);
